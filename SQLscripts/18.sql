...
FROM Student S
JOIN Note N1 ON S.Id = N1.StudentId 
						AND N1.MaterieId = (SELECT Id FROM Materie 
							WHERE Nume = 'Chimie')
JOIN Note N2 ON S.Id = N2.StudentId 
						AND N2.MaterieId = (SELECT Id FROM Materie 
							WHERE Nume = 'Chimie') 
							AND N2.NotaObtinuta >= 5
